...
ols_mod_0 = sqrt(SSE_0/(2*nrow(Galton)))
```
...
It's reasonable to assume they will have similar height, but most likely not exactly identical because their height of both parents and their genes (with a trend towards the human norm)
...
Because the children had a tendency towards the average height; shorter for tall parents, and taller for short parents

Why should this effect be real?

Because height is dependent on many genes and abornmally tall and short people have many dominant and recessive genes working in unison to create an extraordinary result, and very often many of these recessive genes are lost in offspring.

You now have unlocked the mystery. Why is it that when modeling with y continuous, everyone calls it "regression"? Write a better, more descriptive and appropriate name for building predictive models with y continuous.

Because height (y) regressed towards the mean. "Mean-Oriented" could be a better name.
