...
```{r}
logistic_model = glm(paid_in_full ~. , bills_data_train, family = "binomial"(link = "logit"))
#TO-DO
```
...
```{r}
#compute_metrics_prob_classifier = function(p_hats, y_true, res = .001)
bills_data_test = na.omit(bills_data_test)
p_hats = predict(logistic_model, bills_data_test, type = "response")
results_table = compute_metrics_prob_classifier(p_hats, bills_data_test$paid_in_full, res = .001)
#TO-DO
```
